...
export default function DashboardLayout({
  ...
  return (
    <div className="flex flex-col min-h-viewportStable max-h-viewportStable min-w-full blur-125 bg-[url('/aptos_markets_bg_light.jpg')] lg:dark:bg-[url('/aptos_markets_bg_dark.jpg')] dark:bg-[url('/bg-dark-mobile.jpg')] bg-no-repeat bg-cover bg-top">
      <SidenavDesktop />
