...
function generateSVG(svgWidth: number, svgHeight: number, text: string) {
  const buildingAnimations = generateBuildingAnimations(svgWidth, svgHeight);
...
// Generate building animations
function generateBuildingAnimations(svgWidth: number, svgHeight: number) {
  const buildingEmoji = "🏛️";
  const numBananas = 20;
  let bananasSvg = "";
